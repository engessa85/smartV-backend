...
from .views import CompanyListCreateAPIView, UserComaniesView, AppointmentView, UserDashBoardInfo, AllAppointmentView
...
urlpatterns = [
   ...
   path("user-appointment-all", AllAppointmentView.as_view(), name="all_appointment"),
